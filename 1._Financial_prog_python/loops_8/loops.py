...
sum_list = 0.00
for days in portfolio_gain_loss_list:
    sum_list += days
    print(f"The sum of gains and loses for the period are : $ {sum_list:.2f}.")
    print("----------------")
...
print (f"the number of days in the period is: {number_of_days}")
...
print (f"The average G&L per day is: ${average_gain_loss_per_day:.2f}")
...
print (f" The total gain and loss from dict is : {sum_dict:.2f}")
...
print ("the biggest gains where: $", big_gains)
print ("the biggest lost where: $", big_losses)
...
for loose in big_losses:
    total_big_losses += loose

print (f"The big total gains were: ${total_big_gains}")
print (f"The big total looses were: ${total_big_losses}")